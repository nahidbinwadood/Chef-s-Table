...
const Header = () => {
  return (
    <header className='mt-12 px-8 lg:px-0 overflow-hidden'>
      <div className='flex justify-between gap-6 lg:gap-0 items-center'>
        <div>
        ...
        <div className='flex gap-2 items-center'>
          <div className='lg:w-full'>
            <label className="w-2/4 lg:w-full input input-bordered rounded-3xl flex items-center gap-2">
