...
const Header = () => {
    return (
        <header className='container mx-auto mt-12 px-8 lg:px-0'>
        <div className='flex justify-between gap-12 lg:gap-0 items-center'>
          <div>
            <h2 className='text-[#150B2B] font-bold lg:text-4xl'>Recipe Calories</h2>
          </div>
